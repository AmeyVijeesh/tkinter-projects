...
def loginPage(login_data):
    ...
    title = Label(login_frame, text="Quiz App Login", fg="black", bg="white")
    title.config(font='calibri 40')
    title.place(relx=0.2, rely=0.1)

    # USER NAME
    username_label = Label(login_frame, text="Username", fg='black', bg='white')
    username_label.place(relx=0.21, rely=0.4)
    username_entry = Entry(login_frame, bg='white', fg='black', textvariable=user_name)
    username_entry.config(width=42)
    username_entry.place(relx=0.31, rely=0.4)

    # PASSWORD
    password_label = Label(login_frame, text="Password", fg='black', bg='white')
    password_label.place(relx=0.215, rely=0.5)
    password_entry = Entry(login_frame, bg='white', fg='black', textvariable=password, show="*")
    ...
    login_button = Button(login_frame, text='Login', padx=5, pady=5, width=5, command=check, fg="white", bg="black")
...
def signUpPage():
    ...
    # full name
    name_label = Label(signup_frame, text="Name:", fg='black', bg='white')
    ...
    # username
    username_label = Label(signup_frame, text="Username: ", fg='black', bg='white')
    username_label.place(relx=0.21, rely=0.5)
    username_entry = Entry(signup_frame, bg='black', fg='white', textvariable=username, relief=FLAT)
    username_entry.config(width=42)
    username_entry.place(relx=0.31, rely=0.5)

    # password
    password_label = Label(signup_frame, text="Password: ", fg='black', bg='white')
    password_label.place(relx=0.215, rely=0.6)
    password_entry = Entry(signup_frame, bg='black', fg='white', textvariable=password, show="*", relief=FLAT)
    password_entry.config(width=42)
    password_entry.place(relx=0.31, rely=0.6)

    # country
    country_label = Label(signup_frame, text="Country: ", fg='black', bg='white')
    country_label.place(relx=0.217, rely=0.7)
    country_entry = Entry(signup_frame, bg='black', fg='white', textvariable=country, relief=FLAT)
    ...
    def addUserToDataBase():
        ...
        if len(name_entry.get()) == 0 and len(username_entry.get()) == 0 and len(password_entry.get()) == 0 \
            ...
            error = Label(text="Please enter all fields", fg='black', bg='white')
            error.place(relx=0.37, rely=0.7)
    ...
    # signup BUTTON
    sp = Button(signup_frame, text='SignUp', padx=5, pady=5, width=5, command=addUserToDataBase, bg="black", fg="white")
...
def menu(parameter):
    ...
    wel = Label(menu_canvas, text='Welcome to the quiz app by Amey', fg="white", bg='black')
    ...
    level = Label(menu_frame, text='Select your Difficulty Level:', bg="white", fg='black', font="calibri 18")
    ...
    continue_button = Button(menu_frame, text="Let's Go", bg="black", fg="white", font="calibri 12", command=navigate)
...
def easy():
    ...
    next_button = Button(easy_frame, command=display, text="Next", fg="white", bg="black")
...
def medium():
    ...
    submit = Button(normal_frame, command=calc, text="Submit", fg="white", bg="black")
    submit.place(relx=0.5, rely=0.82, anchor=CENTER)

    next_button = Button(normal_frame, command=display, text="Next", fg="white", bg="black")
    next_button.place(relx=0.87, rely=0.82, anchor=CENTER)
...
def difficult():
    ...
    next_question = Button(hard_frame, command=display, text="Next", fg="white", bg="black")
...
def marks(mark):
    ...
    result_label = Label(marks_window, text=result, fg="black", bg="white")
    result_label.pack()
    ...
    re_attempt_button = Button(text="Re-attempt", command=myeasy, bg="black", fg="white")
    ...
    sign_out_button = Button(text="Sign Out", command=callsignUpPage, fg="white", bg="black")
...
def start():
    ...
    button = Button(root, text='Start', command=signUpPage, bg="black", fg="yellow")
